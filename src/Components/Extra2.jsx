...
const Extra2 = () => {
  return (
    <InView>
    {({ inView, ref, entry }) => ( 
  <section ref={ref} id='extra1-2' className={`flex md:flex-row flex-col py-4 md:py-[7.5%] justify-between items-center ` + (inView ? "animate-fade-up animate-ease-in-out animate-delay-300 " : "") }>
